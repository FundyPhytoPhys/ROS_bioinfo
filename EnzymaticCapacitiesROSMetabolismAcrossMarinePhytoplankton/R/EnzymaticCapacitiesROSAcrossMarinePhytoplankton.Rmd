...
- Ascorbate peroxidase universally present (in eukaryotes, but not prokaryotes) - other roles, ascorbate peroxidase is also sensitive to a concentration of substrates (small km) and is likely well conserved for the roles in h2o2 metabolism.
- GR almost universally present (both prokaryotes and eukaryotes) - signaling roles 
...
```
 ...
 All substrates and products are in a gret box
