...
TaxaColors = c("Green" = "darkgreen", # "Diatom" = "brown4", 
               "Ochrophyte" = "brown4", 
               "Haptophyte" = "royalblue", # "Pelagophyte" = "navy",  # "Eustigmatophyte" = "purple", 
...
genomes <- MergedData %>%
  filter(Ome == "Genome")
OmesPairs <- inner_join(genomes, transcriptomes, by = c("Genus", "species", "Strain", "EnzymeName", "Taxa", "Flagella", "Name", "Radius_um", "Latitude", "ECNumber", "Rad1_um", "Rad2_um", "Rad3_um", "Longitude", "ColonySpecies", "Phylum"), suffix = c(".g", ".t"))
MergedData %<>%
