...
`FigureMaterial` contains figures used in either manuscript that were not generated in R.

`ROS_Phytoplankton.bib` is a .bibtex file containing citations from each of the three manuscripts.